const pangrams = [
    ...
    'abcdEFGhijklmnopqrSTuvWXyx',
    'AbcdEfgHIjklmNOPQrstuVWxyx',
    'abcdefghijklmnoF8s9(D*f DS*(f (SD F*pqrstuvwxyx',
    'abcDEfgh98e7rt798329r9ufsdfijklmnopqrstuvwxyx',
    'aBcdefghijkLMnopqrstuvwxy()D())(@#$*)(#*_!@&*&^x',
    'abcdEFGhijklmno⋌༼ •̀ ⌂ •́ ༽⋋pqrSTuvWXyx',
    '🙂A🙂b🙂c🙂d🙂E🙂f🙂g🙂H🙂I🙂j🙂v🙂k🙂l🙂m🙂N🙂O🙂P🙂Q🙂r🙂s🙂t🙂v🙂u🙂V🙂W🙂x🙂y🙂v🙂x🙂z',
    'abcdefghijkl*SEF*9o#(mnopqrstuvwxyx',
    'abcDEfghijklmnopqrstuvw34to(DG()xyx',
    'aBcdefghijkLMnopqrstuvwxyx',
    'abcdEFGAWI893r*(DG()hijklmnopqrSTuvWXyxDSGIO89s98df7',
    'AbcdEfgHIjk#R*#(939082357(D*f s df90a8 ds faslmNOPQrstuVWxyx',
